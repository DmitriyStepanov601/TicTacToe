...
public class Game {
    ...
    private static final String TXTHELP = "<html><center><H2>Help</H2></center><center>Players " +
            "take turns putting signs on the free cells of the 3x3 field (one is always tic-tac-toe, " +
            "the other is always zeros). The first player to line up 3 of his pieces vertically, " +
            "horizontally, or diagonally wins. The first move is made by the player who puts the " +
            "crosses. Usually, at the end of the game, the winning side crosses out its three " +
            "signs (zeros or crosses), which make up a continuous row.</center></html>";

    private static final String TITLE_ABOUT = "About";
    private static final String TXTABOUT = "<html><center><H2>About</H2></center><center>Initially, " +
            "the game had a different name, namely \"heriki-oniki\". It was called so until the " +
            "spelling reform, carried out in 1918. The name is explained by the fact that our " +
            "ancestors perceived this fun not with the figures of a cross and a zero, but with the " +
            "letters of the alphabet \"x\" and \"o\", which were then called\" her \"and\"it\". " +
            "\"Heriki-oniki\" was the most popular board game of the time.<br>" +
            "There are many theories about the origin of this game. However, certain versions have " +
            "some shortcomings. But there are a few more likely ones. <br>" +
            "Nothing is known for sure about the fate of tic-tac-toe, but there is a hypothesis " +
            "that it was invented by a French mathematician, and quite by accident, while solving a " +
            "three-level system of equations. There was a time when this fun got so popular that there " +
            "were several themed cafes with this game. Moreover, such establishments had a fairly " +
            "high demand. There were cases when playing tic-tac-toe, people missed very important " +
            "events, including executions, after which the church banned this childishness. But this did " +
            "not greatly affect the number of players, just everyone started playing secretly.<br>" +
            "Another theory suggests that the Italian artist's painting depicted the Pope playing " +
            "tic-tac-toe with himself. Over time, Kazimir Malevich made a copy of this painting." +
            "And a few more interesting facts: by the end of the XIX century, 14 songs, 3 waters, " +
            "6 stories and about two hundred and fifty articles were devoted to tic-tac-toe " +
            "in Europe.</center></html>";
